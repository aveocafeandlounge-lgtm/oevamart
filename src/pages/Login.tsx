      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-card p-8">
          ...
          <div className="mt-6">
            ...
            <button className="mt-4 w-full flex items-center justify-center gap-2 px-4 py-3 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
